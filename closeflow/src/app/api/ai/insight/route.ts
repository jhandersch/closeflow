        ...
        messages: [
          {
            role: "system",
            content:
              "You are a senior B2B sales strategist. Generate concise CRM recommendations from real lead metrics. Return valid JSON with headline, detail, actions (array), confidence.",
          },
          {
            role: "user",
