...
export default function TasksPage() {
  ...
  const [taskLeadId, setTaskLeadId] =
    useState("")
  ...
  useEffect(() => {
    const load = async () => {
      ...
      const normalizedTasks = ((taskData || []) as Task[]).map(
        (task) => ({
          ...task,
  ...
  const createTask =
    async () => {
       ...
       * aktuell keine description-Spalte besitzt.
       */
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          >
            {
              isDe
                ? "Verfolge Follow-up-Arbeit in deinem Workspace."
