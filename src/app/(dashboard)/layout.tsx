    ...
    return (<div className="flex min-h-screen bg-background text-foreground">
      ...
      <main className="flex-1 overflow-x-hidden">
        ...
        <div className="sticky top-0 z-30 flex items-center gap-4 border-b border-border-subtle bg-background/90 px-4 py-3 backdrop-blur-sm lg:hidden">
          <button onClick={toggle} className="flex h-9 w-9 items-center justify-center rounded-xl border border-border-subtle text-foreground/70 transition hover:bg-foreground/5 hover:text-foreground">
            <Menu size={18}/>
          </button>
