    ...
    return (<main className="mx-auto min-h-screen w-full max-w-4xl px-6 py-12 text-foreground sm:px-8">
      <div className="rounded-3xl border border-border-subtle bg-surface-1 p-8">
        ...
        <p className="mt-4 text-sm leading-7 text-foreground/70">
          Information pursuant to Section 5 TMG. Replace placeholders with final company details before go-live.
        </p>
        ...
        <section className="mt-8 space-y-2 text-sm leading-7 text-foreground/85">
          ...
          <p>10115 Berlin</p>
          <p>Englishland</p>
          <p>Email: legal@closeflow.example</p>
          <p>Phone: +49 30 000000</p>
        ...
        <section className="mt-8 text-sm leading-7 text-foreground/75">
          ...
          <p className="mt-2">
            This page was prepared with the greatest care. However, no guarantee can be made for its accuracy, completeness, or currency.
          </p>
        </section>
