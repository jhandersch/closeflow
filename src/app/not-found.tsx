  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-6 text-foreground">
      <div className="w-full max-w-xl rounded-3xl border border-border-subtle bg-surface-1 p-10 shadow-2xl">
        ...
        <h1 className="mt-4 text-4xl font-semibold">{isDe ? "Seite nicht gefunden" : "Page not found"}</h1>
        <p className="mt-4 text-base leading-7 text-foreground/65">
          {isDe ? "Die gesuchte Seite existiert nicht oder wurde verschoben." : "The page you are looking for does not exist or may have been moved."}
        </p>
