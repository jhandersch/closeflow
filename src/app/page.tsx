      ...
      <main>
        <section className="mx-auto grid max-w-7xl gap-12 px-6 py-16 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:px-10 lg:py-24">
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <a href="#product" className="rounded-2xl border border-border-subtle px-5 py-3 font-semibold text-foreground/85 transition hover:bg-white/5">
                View Demo
              </a>
            </div>
            ...
            <div className="rounded-[1.5rem] border border-border-subtle bg-surface-2/95 p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-1 text-3xl font-semibold text-foreground">â‚¬184k projected</p>
                </div>
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                ...
                <div className="rounded-2xl border border-border-subtle bg-white/5 p-4">
                  ...
                  <p className="mt-2 text-2xl font-semibold text-amber-300">â‚¬24k</p>
                </div>
              </div>
        ...
        <section className="mx-auto max-w-7xl px-6 py-16 sm:px-8 lg:px-10">
          <div className="grid gap-8 rounded-[2rem] border border-border-subtle bg-surface-1 p-8 lg:grid-cols-[0.95fr_1.05fr] lg:p-10">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-semibold text-foreground">Traditional CRMs only store information.</h2>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="mt-4 space-y-3 text-sm leading-7 text-foreground/65">
                    <li>â€¢ AI explains what matters most in the pipeline</li>
                    <li>â€¢ Teams spend less time hunting for context</li>
                    <li>â€¢ Revenue forecasting becomes easier to trust</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <section className="mx-auto max-w-7xl px-6 py-16 sm:px-8 lg:px-10">
          <div className="rounded-[2rem] border border-border-subtle bg-surface-1 p-8 text-center lg:p-12">
            ...
            <h2 className="mt-3 text-3xl font-semibold text-foreground sm:text-4xl">Built for modern sales teams</h2>
        ...
        <section id="pricing" className="mx-auto max-w-7xl px-6 py-16 sm:px-8 lg:px-10">
          <div className="rounded-[2rem] border border-cyan-500/20 bg-cyan-500/10 p-8 text-center lg:p-12">
            ...
            <h2 className="mt-3 text-3xl font-semibold text-foreground sm:text-4xl">Ready to improve your sales process?</h2>
