...
export async function POST(request: Request) {
    ...
    try {
        ...
        /*
         * The invitation was already inserted.
         * Remove it again if email delivery fails,
         * so a retry does not hit the unique
         * workspace/email constraint.
         */
        const {
            error: cleanupError,
        } = await supabase
