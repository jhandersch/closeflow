  ...
  for (
    ...
    if (
      ...
      addIssue({
        row: rowNumber,
        reason:
          "Duplicate customer (contact + company already exists)",
        company:
          company.trim(),
        contact:
          contact.trim(),
