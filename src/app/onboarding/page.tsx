  ...
  const handleFinish = async () => {
    ...
    try {
      ...
      if (userError || !user) {
        throw new Error(
          isDe
            ? "Du musst angemeldet sein, um das Onboarding abzuschliessen."
      ...
      setError(
        err instanceof Error
          ? err.message
          : isDe
            ? "Beim Abschluss des Onboardings ist ein Fehler aufgetreten."
        ...
        <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-2xl border border-border-subtle bg-surface-2/70 p-5">
                  ...
                  <ul className="mt-4 space-y-3 text-sm text-foreground/65">
                    <li>
                      - {isDe
                        ? "Firma und Team-Kontext hinterlegen"
                ...
                <div className="rounded-2xl border border-border-subtle bg-surface-2/70 p-5">
                  ...
                  <p className="mt-2 text-sm leading-7 text-foreground/65">
                    {isDe
                      ? "Wähle den schnellsten Weg zu deinem Aha-Moment."
                  ...
                  <div className="mt-4 grid gap-3 md:grid-cols-2">
                    ...
                    >
                      ...
                      <p className="mt-1 text-xs">
                        {isDe
                          ? "Bester Pfad für produktiven Start."
                    ...
                    >
                      ...
                      <p className="mt-1 text-xs">
                        {isDe
                          ? "Sofort gefüllte Pipeline zum Erkunden."
            ...
            {step === 1 && (
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-7 text-foreground/65">
                    {isDe
                      ? "Diese Angaben personalisieren dein CRM."
              ...
              <div className="space-y-5">
                ...
                "lead" ? (
                  ...
                  <div className="rounded-2xl border border-cyan-500/20 bg-cyan-500/10 p-5 text-sm leading-7">
                    Beim Abschluss werden realistische Demo-Leads, Aktivitäten und Aufgaben geladen.
                  </div>
                )}
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-3xl border border-border-subtle bg-surface-1 p-6">
              <h3 className="text-lg font-semibold">
                {isDe
                  ? "Warum Onboarding hilft"
                  : "Why onboarding helps"}
              </h3>

              <p className="mt-3 text-sm leading-7 text-foreground/65">
                {isDe
                  ? "Ein schnelles Setup macht dein neues CRM sofort nutzbar."
            ...
            <div className="rounded-3xl border border-border-subtle bg-surface-1 p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-foreground/65">
                {isDe
                  ? "Firmendaten und Onboarding-Status werden in Supabase gespeichert."
            ...
            <div className="rounded-3xl border border-border-subtle bg-surface-1 p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-foreground/65">
                {isDe
                  ? "Lade realistische Beispieldaten."
