...
export function useRevenueForecastAI(leads: Lead[], forecast: ForecastSummary, language: "en" = "en") {
            ...
            try {
                ...
                setInsight({
                    ...
                    recommendations: Array.isArray(data.recommendations)
                        ...
                        : [],
                    pipelineComment: data.pipelineComment ?? "",
                    singleDealRisk: typeof data.singleDealRisk === "number"
                        ? data.singleDealRisk
                        : 0,
                });
                setError(null);
                ...
                console.error("Revenue Forecast AI:", error);
                setInsight(null);
