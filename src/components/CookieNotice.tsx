...
export default function CookieNotice() {
  ...
  return (
    <div className="fixed inset-x-4 bottom-4 z-[60] mx-auto max-w-3xl rounded-2xl border border-border-subtle bg-surface-1/95 p-4 shadow-2xl backdrop-blur-sm sm:inset-x-6">
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        <button
          type="button"
          onClick={acknowledge}
          className="rounded-xl bg-cyan-500/90 px-4 py-2 text-sm font-semibold text-white transition hover:bg-cyan-500"
        >
          Alle akzeptieren
        </button>
        <Link
          href="/cookies"
          className="rounded-xl border border-border-subtle px-4 py-2 text-sm font-semibold text-foreground/85 transition hover:bg-foreground/5"
        >
