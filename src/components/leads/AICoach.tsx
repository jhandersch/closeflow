...
export default function AICoach({ title, message, reasons, action, confidence, }: AICoachProps) {
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <div className="mt-4 space-y-2">
            ...
            {reasons.map((reason) => (<div key={reason} className="rounded-xl border border-border-subtle bg-surface-2/70 px-4 py-2 text-sm text-foreground/80">
                {reason}
              </div>))}
