...
export default function AIInsightCard({ insight }: AIInsightCardProps) {
    ...
    return (<section className="rounded-2xl border border-cyan-500/20 bg-gradient-to-br from-cyan-500/10 via-blue-500/5 to-transparent p-6" aria-labelledby="ai-insight-heading">
      ...
      <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between">
        ...
        <div className="flex gap-4">
          ...
          <div>
            ...
            <h2 id="ai-insight-heading" className="mt-2 text-2xl font-bold text-foreground">
              {insight.headline}
            </h2>
        ...
        <div className={`rounded-full border px-4 py-2 text-sm font-semibold ${confidenceColor}`}>
      ...
      <div className="mt-6">
        ...
        <div className="space-y-3">
          ...
          {insight.actions.map((action, index) => (<div key={action} className="flex items-center gap-3 rounded-xl border border-border-subtle bg-surface-2/70 p-4">
