...
export default function PipelineChart({ data, }: PipelineChartProps) {
    ...
    const stageLabels: Record<string, string> = {
        New: t("pipeline.new", "New"),
        Contacted: t("pipeline.contacted", "Contacted"),
        Proposal: t("pipeline.proposal", "Proposal"),
        Won: t("pipeline.won", "Won"),
        Lost: t("pipeline.lost", "Lost"),
    };
    const translatedData = data.map((item) => ({
        ...item,
        name: stageLabels[item.name] ??
            item.name
    }));
      ...
      <div className="flex items-center justify-between">
        ...
        <div>
          ...
          <h2 className="
            ...
            text-foreground
            ">
            {t("dashboard.dealDistribution", "Deal distribution")}
          </h2>
        ...
        <div className="
          ...
          <Link href="/pipeline" className="hover:underline">
            {t("dashboard.openPipeline", "Open pipeline")}
          </Link>
