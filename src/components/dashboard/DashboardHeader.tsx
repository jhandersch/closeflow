...
export default function DashboardHeader({ forecast, userName, totalLeads, pipelineValue, attentionCount, }: DashboardHeaderProps) {
      ...
      <div className="
        ...
        <div className="max-w-3xl">
          ...
          <p className="
            ...
            max-w-2xl
            ">
            {t("dashboard.salesOverview", "Your sales overview and AI recommendations for today.")}
          </p>
        ...
        <div className="
          ...
          <p className="mt-2 text-sm text-emerald-300">
            {t("dashboard.predictedPipelineOutcome", "Predicted pipeline outcome")}
          </p>
