...
export default function RoleSelector({ value, onChange, disabled }: RoleSelectorProps) {
  return (
    <select
      ...
      className="rounded-xl border border-border-subtle bg-surface-2 px-3 py-2 text-sm text-foreground outline-none focus:border-cyan-400 disabled:opacity-60"
    >
