...
export async function captureWorkspaceError(supabase: SupabaseClient, userId: string, input: ErrorCaptureInput): Promise<boolean> {
...
export async function listWorkspaceErrors(supabase: SupabaseClient, workspaceId: string, limit: number): Promise<AuditRow[]> {
