-- Team workspace foundation: organizations, members, invites
-- Apply with your Supabase migration workflow (e.g. supabase db push)
...
-- Organizations can be read/modified by active members
...
-- Members list visible to active members. Member updates by owner/admin.
...
-- Invites managed by owner/admin, readable by active members
